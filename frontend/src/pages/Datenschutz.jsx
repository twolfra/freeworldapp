  ...
  return (
    <main className={styles.wrap}>
      <div className={styles.inner}>
        ...
        <h2>2. Hosting</h2>
        <p>
          Diese Website wird bei Google Cloud Run (Google Ireland Limited, Gordon House,
          Barrow Street, Dublin 4, Irland) gehostet. Details entnehmen Sie der
        ...
        <p>
          Sie können sich auf dieser Website registrieren, um zusätzliche Funktionen nutzen
          zu können. Die dazu eingegebenen Daten (Benutzername, E-Mail-Adresse) verwenden
          wir nur zum Zwecke der Nutzung des jeweiligen Angebots oder Dienstes, für den
          Sie sich registriert haben. Die bei der Registrierung abgefragten Pflichtangaben
          müssen vollständig angegeben werden. Anderenfalls werden wir die Registrierung ablehnen.
        </p>
        <p>
          Die eingegebenen Daten werden auf den Servern des Hostinganbieters gespeichert.
          Eine Weitergabe dieser Daten an Dritte findet nicht statt.
        </p>

        <h3>Nutzerinhalte</h3>
        <p>
          Angebote, Gesuche und Nachrichten, die Sie auf dieser Plattform einstellen,
          werden auf unseren Servern gespeichert. Hochgeladene Bilder werden bei Google
          Cloud Storage (Google Ireland Limited) gespeichert.
        </p>

        <h3>Kontaktformular und Direktnachrichten</h3>
        <p>
          Wenn Sie uns per Direktnachricht auf der Plattform kontaktieren, werden Ihre
          Angaben zur Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns
        ...
        <p>
          ...
          beschweren. Die zuständige Aufsichtsbehörde für Sachsen ist der Sächsische
